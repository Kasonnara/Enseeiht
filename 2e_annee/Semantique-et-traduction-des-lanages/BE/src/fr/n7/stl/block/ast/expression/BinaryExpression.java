...
public class BinaryExpression implements Expression {
	...
	public Type getType() {
		...
		switch (this.operator) {
			...
			default :
				Logger.error("Opérateur non référencé pour le checktype : " + this.operator.toString());
				return AtomicType.ErrorType;
		}
	}
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		//	_result.add(_factory.createLoadI(this.left.getType().length()));     // Code pour faire toute les lecture par adresse TODO?
		//}
		_result.append(this.right.getCode(_factory));
		//if (this.right instanceof AccessibleExpression) {
		//	_result.add(_factory.createLoadI(this.right.getType().length()));    // Code pour faire toute les lecture par adresse TODO?
		//}
