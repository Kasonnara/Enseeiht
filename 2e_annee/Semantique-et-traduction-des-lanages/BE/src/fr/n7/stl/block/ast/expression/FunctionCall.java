...
public class FunctionCall implements Expression {
	...
	public boolean resolve(HierarchicalScope<Declaration> _scope) {
		...
		if (decl == null){
			...
			Logger.error("Declaration ("+decl.getName()+") is not callable (not a function)");
			result = false;
		} else{
			this.function = (FunctionDeclaration)decl;
		}

		// resolve les paramètres
		for (Expression arg : this.arguments) {
			boolean resultInstr = arg.resolve(_scope);
			//System.out.println("parameter [in functionCall]" + (resultInstr ? "OK" : "FAIL"));
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		// call
		frag.add(_factory.createCall(this.function.getStartLabel(), Register.LB));
		frag.addComment("Function "+this.name+" call");
