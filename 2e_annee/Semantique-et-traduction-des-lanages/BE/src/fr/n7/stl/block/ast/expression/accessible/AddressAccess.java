...
public class AddressAccess implements AccessibleExpression {
	...
	public boolean resolve(HierarchicalScope<Declaration> _scope) {
		boolean result = this.assignable.resolve(_scope);
		// TODO probablement autre chose a faire pour vérifier si on a pas le droit d'utiliser &?
		return result;
	}
	...
	public Fragment getCode(TAMFactory _factory) {
		// Empiler l'adresse de l'assignable
